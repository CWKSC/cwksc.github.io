...
- For an **unbiased estimator**, we generally divide by $N-1$ (Bessel's correction). The MLE process purely optimizes probability based _only_ on the observed sample context, causing the slight bias in variance.
