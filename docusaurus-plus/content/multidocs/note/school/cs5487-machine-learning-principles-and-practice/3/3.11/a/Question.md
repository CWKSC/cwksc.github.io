...
where $\theta = [\theta_1, \dots, \theta_D]^T$ is the parameter vector, $y = [y_1, \dots, y_n]^T$ is the vector of outputs, $\{x_1, \cdots, x_n\}$ are the set of corresponding inputs, $\phi(x_i)$ is a feature transformation, with
