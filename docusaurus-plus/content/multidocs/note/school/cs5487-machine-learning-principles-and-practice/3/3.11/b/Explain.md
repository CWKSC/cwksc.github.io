...
3.  **MAP Estimate** takes WLS and adds a **Prior Belief**. Often, in machine learning, perfectly fitted models with extreme parameter values behave wildly on new data. The MAP approach says, "I'll do my best to fit the data, _but_ I refuse to let my parameters get crazy large."
