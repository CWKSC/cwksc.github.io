...
Because the optimizer is trying to find the _minimum_ cost! The term $\lambda (\theta^+_i + \theta^-_i)$ acts as a penalty. If the optimizer picked $\theta^+_i = 10, \theta^-_i = 5$, it pays a massive penalty of $15\lambda$.
