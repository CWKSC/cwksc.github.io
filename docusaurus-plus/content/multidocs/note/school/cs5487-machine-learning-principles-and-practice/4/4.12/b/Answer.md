...
_(Note: As with part (a), we temporarily ignore the inequality constraint $\pi_j \ge 0$. We will find a stationary point and verify that the resulting solution mathematically produces non-negative values.)_
