...
> Node can have a maximum of `m` children
> 
> Node can contain a maximum of `m - 1` keys
> 
> Node should have a minimum of `ceil(m / 2)` children
> 
> Node (except root node) should contain a minimum of `ceil(m / 2) - 1` keys
